...
/**
 * Interface Tree
 * @author Giampietri Gonzalo Emanuel
 */
...
public interface Tree<E> extends Iterable<E>{
		 ...
		 * @return Posicion del nodo padre del nodo correspondiente a la posician dada.
		 ...
		 * @throws InvalidPositionException si la posicion pasada por parometro es invalida.
		 */
		 ...
		 * @param rb posicion del nodo que sera el hermano derecho del nuevo nodo.
		 * @return La posicion del nuevo nodo creado.
		 * @throws InvalidPositionException si la posicion pasada por parametro es invalida, o el esta esta vacio, o la posicion rb no corresponde a un nodo hijo del nodo referenciado por p.
		 */
